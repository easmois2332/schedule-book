  ...
  <div class="help-view-area">
    ...
    <div class="content-area">
      <span>
        ...
        本サイトの情報、計算は仮説、検証中のものが含まれます。その正確性は保証いたしません。<br>
        また、本サイトの情報、計算結果によって受けた損害については一切の責任を負いません。
      </span>
    </div>
    <div class="common-headline">
    ...
    <div class="content-area">
      <span>
        ...
        PC端末、タブレット端末での使用を強く推奨します。<br>
        スマートフォン端末でも動作はしますが、操作性が著しく低下します。
      </span>
    </div>
    <div class="common-headline">
    ...
    <div class="content-area">
      <div class="icon-area">
        ...
        <span class="icon-name">Pアイドル</span>
      </div>
      <span>
    ...
    <div class="content-area">
      <div class="icon-area">
        ...
        <span class="icon-name">サポートカード</span>
      </div>
